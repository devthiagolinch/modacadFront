...
export function Header() {
    return (
        <div className="flex fixed lg:items-center w-[100%]  border-b-2 border-zinc-950 bg-neutral-200
        ...
        ">
            ...
            <div className="flex w-full justify-between relative">
                ...
                <nav className="flex items-center">
                    ...
                    <a href="" className="font-normal border-l-2 lg:font-medium lg:text-sm lg:border-2 lg:border-r-0 lg:border-b-0 lg:border-t-0 lg:border-zinc-950 md:w-50 md:h-20 lg:px-5 lg:py-7 ">Criar Perfil</a>
