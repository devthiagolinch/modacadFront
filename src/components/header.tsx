        ...
        ">
            <div className="flex w-full justify-between relative">
                ...
                <nav className="flex items-center">
                    <a href="/blanck" className="hidden lg:flex font-medium text-sm border border-r-0 border-b-0 border-t-0 border-zinc-950 w-50 h-20 px-5 py-7 tracking-[0.05em]
                    ...
                    ">Criar Perfil</a>
                    <a href="" className="font-medium text-sm border border-r-0 border-b-0 border-t-0 border-zinc-950 w-50 h-20 px-6 py-6 pt-7
                        hover:bg-[#dcdf1e]
                    ">
                        ...
                        {/** <img src={shopIcon} alt=""  className="h-9 lg:h-7 lg:stroke-2 stroke-2" /> */}
                    </a>
                    ...
                    ">
                        ...
                        {/** <img src={pesquisaicon} alt=""  className="h-7 lg:h-5" /> */}
                    </a>
                    ...
                    ">
                        ...
                        {/** <img src={menuIcon} className="h-5 lg:h-4 stroke-2" /> */}
                    </a>
                </nav>
            </div>
