  ...
  return (
    <div className="flex flex-col gap-10 px-[5px] py-[10px] justify-center items-center bg-gray-700">
      ...
      <div className="">
        ...
        <div
          className="border-t-0 border-[1px] border-[#202020]
                    p-[10px]
                "
        >
          {texto?.tag.map((t) => <span className="font-montserratLight text-[12px] -mt-[5px]">{t}</span>)}

          <h1 className="font-butler_regular text-[25px] leading-[30px] mb-[13px] mt-[5px]">{texto?.title}</h1>

          <p className="font-montserratRegular text-[17px] leading-[20px]">{texto?.description}</p>
        </div>
      </div>
      <div className="">
        <div className=" border-[1px] border-[#202020]">
        ...
        >
          ...
          <h1 className="font-butler_regular text-[25px] leading-[30px] mb-[13px] mt-[5px]">
            The art g of creative problem-solving The art of creative
          </h1>
      ...
      <div className="flex w-[100%] gap-[5px]">
        <div
          className="w-[172px] border-[1px] border-[#202020]
