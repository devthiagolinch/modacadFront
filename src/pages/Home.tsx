      ...
      ">
          <div className="flex w-screen justify-between ">
              ...
              <nav className="flex items-center">
                  <Link to="/admin-login" className="hidden lg:flex font-normal text-sm border border-r-0 border-b-0 border-t-0 border-zinc-950 w-50 h-20 px-5 py-7 tracking-[0.05em]
