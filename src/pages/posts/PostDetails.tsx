  ...
  if (show) {
      ...
      <div className="mx-auto">
        ...
        <div className="hidden lg:flex lg:flex-col  lg:w-full">
          <div className="lg:flex  lg:pb-5 2xl:gap-[14.5%] lg:gap-[12%] lg:justify-between">
            ...
            <div className="lg:flex lg:flex-col lg:pr-[20%] ">
              ...
              <p className="lg:text-left lg:text-[20px] w-[100%] lg:font-montserrat_regular">{text?.description}</p>
            </div>
          </div>
        ...
        <div className="lg:hidden">
          <div className=" pt-16 pb-5 w-full px-5 grid gap-5">
            <h1 className="lg:text-3xl text-[40px] leading-[40px] font-butler_ultra_light">{text?.title}</h1>

            <p className="text-left leading-[20px]">{text?.description}</p>
          </div>
          ...
          <div className="flex flex-col ">
            ...
            <div className="flex justify-between items-start align-top gap-10 px-5 mb-[20px] text-zinc-800">
              <div className="flex flex-col font-montserrat_light_italic">
                {text?.tag.map((tag) => <span className="-mb-[5px] text-[13px]">{tag.toUpperCase()}</span>)}
              </div>
        ...
        <div className="lg:pt-12 lg:px-[20%] mb-[40px] mx-[20px]">
          <p className="text-justify lg:text-lg font-montserrat_light">{text?.text}</p>
        </div>
        <Footer />
      </div>
    );
    ...
    return (
      <div className="mx-auto">
        ...
        <div className="lg:hidden">
          <div className=" pt-16 pb-5 w-full px-5 grid gap-5">
            <h1 className="text-3xl font-butler_ultra_light">{text?.title}</h1>
        ...
        <div className="lg:pt-12 lg:px-[20%] mb-[40px] mx-[20px]  ">
          <p className="lg:text-justify lg:text-lg font-montserrat_light lg:h-40 h-48 overflow-hidden">{text?.text}</p>
        </div>
        <BlockText />
        <Footer />
      </div>
