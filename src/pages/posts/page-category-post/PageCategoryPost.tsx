    ...
    <div>
      ...
      <div className="container mx-auto p-4">
        <div className="flex gap-2 items-center">
          ...
          <hr className="grow border-t border-gray-950 hidden md:block" />
        </div>
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-12 md:col-span-7 mb-[64px] md:mb-0">
          ...
          <div className="col-span-12 md:col-span-5">
            ...
            <PostGrid posts={pilulas} columns={{ xs: 1, lg: 2 }} />
          </div>
        </div>
