...
export function Footer() {
  ...
  return (
    <>
      ...
      <div className="grid font-butler font-light">
        ...
        >
          ...
          <div className="flex justify-start items-center px-[20px] mt-[30px] mb-[35px] lg:hidden">
            <p className="text-[40px] font-butler_ultra_light md:text-7xl leading-[40px]">
              Nossas <br /> redes sociais
            </p>
          ...
          <div className="grid grid-cols-3 gap-x-4 gap-y-4 md:my-10 h-auto px-[20px] mb-[40px]">
            <div
              className="md:w-[130px] md:h-[100px] grid justify-center items-center w-full h-[60px]
        ...
        >
          <h1
            className=" font-butler_ultra_light text-[40px] lg:text-[72px] mb-[30px] leading-[40px] lg:leading-[70px] lg:w-[40%]
                "
          >
            Quer falar comigo?
          </h1>
          ...
          <div className="lg:flex-1 lg:ml-[194px]">
            <ul className="flex flex-col gap-7 md:w-full">
              <li
                className="flex gap-2 font-montserrat_medium lg:text-[24px] items-center
